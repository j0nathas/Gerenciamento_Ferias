...
const CustomTooltip = ({ task, fontSize, fontFamily }) => {
    ...
    return (
        <div className="gantt-tooltip" style={{ fontFamily, fontSize }}>
            ...
            <p className="gantt-tooltip__progress-label">{Math.round((task.end - task.start) / (1000 * 60 * 60 * 24) + 1)} dias</p>
        </div>
    );
};
            ...
            <div className="calendar-wrapper">
                <div className='calendar-view'>
                    ...
                    <div className="calendar-view-toggle">
                        ...
                        >
                            {editMode ? <EditIcon width={25} height={25} /> : <ViewIcon width={25} height={25} />}
                        </button>
                    </div>
                </div>
                ...
                <div className="gantt-wrapper">
                    <Gantt
                        ...
                        onDateChange={editMode ? (task) => setEmployees(prev => prev.map(t => t.id === task.id ? task : t)) : null}
